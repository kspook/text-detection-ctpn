...
#                os.makedirs('data/crpd_img/'+base_name+'/')
            ...
            cropImage.save ('data/crpd_img/'+base_name+'/'+base_name+str(i)+'.png')
			
            img_saved = cv2.imread('data/crpd_img/'+base_name+'/'+base_name+str(i)+'.png')
            ...
            cv2.imwrite('data/crpd_img/'+base_name+'/'+base_name+str(i)+'.png', img_saved)

            syn_base_name = base_name + '/'+ base_name+str(i)+".png"
            ...
            #if i==0 :
            wocr.perform_ocr(i, filename, syn_base_name)
