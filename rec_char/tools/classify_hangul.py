...
# Default paths.
DEFAULT_LABEL_FILE = './ibm_src/labels/2350-common-hangul.txt'
DEFAULT_GRAPH_FILE = './ibm_src/saved-model/optimized_hangul_tensorflow.pb'
...
#def classify(args):
    ...
    """
    labels = io.open(DEFAULT_LABEL_FILE,
